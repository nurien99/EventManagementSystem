...
namespace EventManagementSystem.Api.Migrations
{
    ...
    [Migration("20250716085346_AddEventAssistants")]
    partial class AddEventAssistants
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventManagementSystem.Core.EmailOutbox", b =>
                {
            ...
            modelBuilder.Entity("EventManagementSystem.Core.EventAssistant", b =>
                {
                    b.Property<int>("EventAssistantID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EventAssistantID"));
            ...
            modelBuilder.Entity("EventManagementSystem.Core.EventAssistant", b =>
                {
                    b.HasOne("EventManagementSystem.Core.User", "AssignedBy")
                        .WithMany()
                    ...
                    b.HasOne("EventManagementSystem.Core.User", "Assistant")
                        .WithMany()
                        .HasForeignKey("UserID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
